...
1. **Your AI provider** — Choose Anthropic (Claude), OpenAI (GPT), or Google (Gemini) and enter your API key. If you don't have a key yet, get one from your provider's dashboard — this is required.
...
If the daemon wasn't installed in Step 2, start the Gateway manually:
