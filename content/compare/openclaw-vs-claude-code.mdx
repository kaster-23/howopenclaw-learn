...
faqs:
  - q: "Is OpenClaw the same as Claude Code?"
    a: "No. OpenClaw is a self-hosted personal AI agent you access through messaging apps like Telegram and WhatsApp. [Claude Code](https://claude.ai/code) is [Anthropic](https://www.anthropic.com)'s official CLI tool for AI-assisted software development in a terminal. They're different products for different purposes and not in competition."
  ...
  - q: "Can I use both OpenClaw and Claude Code?"
    a: "Yes, and many people do. [Claude Code](https://claude.ai/code) handles development work in the terminal. OpenClaw handles everything else — daily briefings, reminders, messaging-based tasks, and personal productivity."
---
...
If OpenClaw fits your use case, the [installation guide](/course/0-setup) walks through setup. Then connect it to your messaging app of choice — [Telegram](/channels/telegram), [WhatsApp](/channels/whatsapp), or [iMessage](/channels/imessage) — and your agent is reachable from your phone.
