...
As of v2026.3.24, OpenClaw streams 1:1 replies in real time. Users see your agent's response appear gradually as it's generated, providing better feedback than waiting for a complete response.
...
As of v2026.3.24, you can edit or delete messages your agent has sent. This includes in-thread fallbacks when no explicit target is provided.
