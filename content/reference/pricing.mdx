...
| NVIDIA | Meta-Llama-3.1-8B | Low |
| Anthropic | claude-sonnet-4-6 | Medium |
| OpenAI | gpt-4o | Medium–High |
| Anthropic | claude-opus-4-6 | High |

<Callout type="info" title="NVIDIA API pricing">
