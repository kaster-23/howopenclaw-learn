...
howToSteps:
  - "Open ~/.openclaw/SOUL.md in your text editor — e.g. `code ~/.openclaw/SOUL.md` for VS Code"
  - "Define your agent's role in 2–3 sentences: what it does, who it serves, and its overall purpose"
  - "Specify communication style: tone (casual, formal, direct), response length, and formatting preferences"
  - "Add domain expertise or personal context relevant to your use case (job, timezone, preferred tools)"
  - "Save the file and restart the Gateway with `openclaw gateway restart` to apply changes"
---
