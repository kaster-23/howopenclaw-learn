...
icon: Clock
description: "Schedule cron tasks in OpenClaw — daily briefings, reminders, automations. Run scheduled tasks 24/7 on a $5/month VPS or keep them on your own machine."
readTime: 6
moduleNumber: 6
learningObjectives:
...
[DigitalOcean](https://digitalocean.com), [Hetzner](https://hetzner.com), or [Vultr](https://vultr.com) all have $5-6/month plans. Choose Ubuntu 22.04+, 1 vCPU, 1 GB RAM minimum (2 GB recommended).
