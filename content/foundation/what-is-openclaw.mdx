...
- An API key from your AI provider — get one from [Anthropic](https://console.anthropic.com), [OpenAI](https://platform.openai.com), or [Google Gemini](https://aistudio.google.com) (you'll enter it during setup)
