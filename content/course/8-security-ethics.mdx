...
**Tailscale** (recommended) creates a private network between your devices.
Your Gateway stays completely off the public internet:

```bash
# With Tailscale installed, your Gateway is accessible
# at your Tailscale IP — no additional configuration needed
```
...
Never expose `http://127.0.0.1:18789` directly to the internet without
authentication.
