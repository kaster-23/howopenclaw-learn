...
faqs:
  ...
  - q: "What Node.js version does OpenClaw require?"
    a: "Node.js 22.14 or later. Node.js 24 LTS is recommended. Older versions (18, 20) are not supported. Check your version with `node --version` and upgrade via nvm if needed."
