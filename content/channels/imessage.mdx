...
If you're on macOS and want the most natural, personal channel, this is the one to set up first. iMessage is the one OpenClaw channel that requires a Mac — see [system requirements](/reference/system-requirements) for details. Like every other channel, it adds no subscription cost — you pay only [your AI provider's API fees](/reference/pricing).
