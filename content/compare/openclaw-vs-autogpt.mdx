...
faqs:
  - q: "Is OpenClaw an autonomous AI agent like AutoGPT?"
    a: "No. OpenClaw is a conversational agent — you control every exchange via messaging. [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) is an autonomous agent that pursues a goal through self-directed steps with minimal human involvement. OpenClaw's bounded model is more reliable for daily personal use."
  ...
  - q: "Which is easier to set up, OpenClaw or AutoGPT?"
    a: "OpenClaw installs in about 15 minutes via a one-line installer. [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT)'s setup involves Docker, multiple API keys, and more complex configuration. For personal daily use, OpenClaw's setup is significantly simpler."
---
...
The [installation guide](/course/0-setup) covers setup if you want to try it. After that, connect to [Telegram](/channels/telegram) for the fastest path to a working agent on your phone, or [Discord](/channels/discord) if you want it in a community server.
