...
faqs:
  ...
  - q: "Can OpenClaw use OpenAI models?"
    a: "Yes. OpenClaw supports Anthropic (Claude), OpenAI (GPT-4), and Google (Gemini). You choose your provider in config. Unlike the OpenAI Assistants API, you're not locked to a single provider."
  - q: "How long does it take to get OpenClaw running vs the Assistants API?"
    a: "OpenClaw takes about 15 minutes to install and configure before your first message. Building an equivalent assistant with the OpenAI Assistants API typically takes hours to days, depending on complexity."
---
