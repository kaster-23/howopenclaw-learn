...
As of v2026.5.7, `openclaw channels list` shows only channel state (installed / configured / enabled). Model auth and usage details moved to `openclaw models auth list` and `openclaw status`.
