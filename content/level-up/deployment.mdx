...
As of v2026.3.28, **Podman setup is simplified** around the current rootless user. The launch helper installs under `~/.local/bin`, and the host-CLI `openclaw --container <name>` workflow is the standard way to interact with containerized instances.
