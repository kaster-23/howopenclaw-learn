---
title: "OpenClaw CLI Reference: Commands, Flags, Logs, Cron, Tools"
description: "OpenClaw CLI reference with every command and flag: gateway, logs, cron list, tools list, skills, channels, config. Real output examples and syntax for each command."
faqs:
