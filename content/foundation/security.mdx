...
Never use `"open"` in production. Anyone who finds your bot's username can then send it messages, which costs you money and potentially gives strangers access to your tools.
...
The officially recommended approach for remote access is Tailscale or another VPN. This keeps your Gateway off the public internet entirely — only devices on your private network can reach it.
